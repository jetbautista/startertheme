    ...
    <div id="STX-admin" class="STX-admin">
            ...
            <div class="STX-tr">
                ...
                <div class="STX-getting-started">
                    ...
                    <iframe class="STX_getting_started__video" width="710" height="400" src="https://www.youtube.com/embed/GxYDH0sjZzE" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                    ...
                    <div class="STX_getting_started__buttons">
                        ...
                        <div class="STX_getting_started__button_dashboard">
                            <a href="<?php echo get_admin_url() . 'admin.php?page=transition_slider_admin&action=dashboard'; ?>"><?php esc_html_e( "Go to Dashboart", "stx"); ?></a>
                        </div>
                    </div>
